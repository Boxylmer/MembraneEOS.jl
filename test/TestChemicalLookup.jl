...
co2_ch4 = UnorderedChemicalPair("CO2", "CH4")
ch4_co2 = UnorderedChemicalPair("CH4", "CO2")
...
co2_ch4_kij = get_kij(MembraneEOS.PRKijLookup, "CO2", "CH4")
@test !ismissing(co2_ch4_kij)
# and it should also be order-agnostic
ch4_co2_kij = get_kij(MembraneEOS.PRKijLookup, "CH4", "CO2")
...
co2_ch4_missing = get_kij_matrix(MembraneEOS.PRKijLookup, ["CH4", "CO2", "Something not in the database"]; missing_value=missing, ideal_value=10)
